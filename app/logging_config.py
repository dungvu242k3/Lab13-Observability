...
AUDIT_LOG_PATH = Path(os.getenv("AUDIT_LOG_PATH", "data/audit_security.jsonl"))
...
class JsonlFileProcessor:
    def __call__(self, logger: Any, method_name: str, event_dict: dict[str, Any]) -> dict[str, Any]:
        ...
        # Separate Audit log for Healthcare records & PII
        if event_dict.get("feature") == "records" or "REDACTED" in rendered:
